<?php
	...
	$result_msg_contato = "INSERT INTO compra_contatos(produto, preco, quantidade, resultado, parcelas, email, senha, endereco, numero, complemento, bairro, cep, cidade, formapagamento, cartaonumero, mesvencimento, anovencimento, total, created) VALUES ('$produto', '$preco', '$quantidade', '$resultado', '$parcelas', '$email', '$senha', '$endereco', '$numero', '$complemento', '$bairro', '$cep', '$cidade', '$formapagamento', '$cartaonumero', '$mesvencimento', '$anovencimento', '$total',  NOW())";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link rel="icon" href="img/icon.png" />
		...
		<title>Obrigado pela preferência ;) - Mystery Geek</title>
...
<div class="barra_pesquisa">
	...
	<div class="contents">
		<div class="principal">
		<img src="img/bannerobrigado.png"><br>
			<h2>O código de rastreio da sua compra é: <b>JA655D4AD44FA4FADA5AD</b></h2><br><br>
			<h2>Continue comprando conosco, vá para a <a href="index.html" style="text-decoration:none">HOME</a> e veja outras ofertas</h2>
		</div>
