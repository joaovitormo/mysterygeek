...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Relógio Parede DC Batman Logo">Relógio Parede DC Batman Logo<br />
                    <img src="img/relogio-1.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="120,00">R$ 119,99</td>
