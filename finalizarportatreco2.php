...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="PORTA TRECO RUBIK">PORTA TRECO RUBIK<br />
                    <img src="img/portatreco-2.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="54,98">R$ 54,99</td>
