<?php
	...
	$result_msg_contato = "INSERT INTO cadastro_contatos(nome, sobrenome, data, cpf, tel, cel, email, senha, created) VALUES ('$nome', '$sobrenome', '$data', '$cpf', '$tel', '$cel', '$email', '$senha', NOW())";
...
<div class="barra_pesquisa">
	...
	<div class="principal">
		<img src="img/bannercadastro.png">
		<h2>Comece já a comprar conosco, vá para a <a href="index.html" style="text-decoration:none">HOME</a> e aproveite as melhores ofertas</h2>				
		<br><br>
	</div>
	</div>
