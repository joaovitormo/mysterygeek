...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Boneco Action Figure SHIKAMARU NARA XTRA FIGURES - NARUTO">Boneco Action Figure SHIKAMARU NARA XTRA FIGURES - NARUTO<br />
                    <img src="img/actionfigures-6.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="399,98">R$ 399,99</td>
