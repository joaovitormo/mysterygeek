...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Funko Pop Breaking Bad Walter White">Funko Pop Breaking Bad Walter White<br />
                    <img src="img/funko-5.jpg" width="200px"; height="200px"
                    </td>
