...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Livro 2001: Uma Odisséia no Espaço">Livro 2001: Uma Odisséia no Espaço<br />
                    <img src="img/livro-11.jpg" width="200px"; height="200px"
                    </td>
