...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Quadro decorativo Capitão América">Quadro decorativo Capitão América<br />
                    <img src="img/quadro-2.png" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="34,98">R$ 34,99</td>
