...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caderno 10 Materias Super Mario Bros 200">Caderno 10 Materias Super Mario Bros 200<br />
                    <img src="img/caderno-3.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="25,98">R$ 25,99</td>
