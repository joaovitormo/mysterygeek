...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Luva de Cozinha DC I’m Batman">Luva de Cozinha DC I’m Batman<br />
                    <img src="img/luva-1.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="24,98">R$ 24,99</td>
