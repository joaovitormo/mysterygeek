...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Action Figure Kratos 7": God of War 4 - Boneco Colecionável">Action Figure Kratos 7": God of War 4 - Boneco Colecionável<br />
                    <img src="img/actionfigures-4.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="299,98">R$ 299,99</td>
