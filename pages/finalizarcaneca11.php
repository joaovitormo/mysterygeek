...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca Folha de Fichário com Caneta">Caneca Folha de Fichário com Caneta<br />
                    <img src="img/caneca-11.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="19,98">R$ 19,99</td>
