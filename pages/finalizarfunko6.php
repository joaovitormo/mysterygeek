...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Funko Pop Piratas do Caribe - Jack Sparrow">Funko Pop Piratas do Caribe - Jack Sparrow<br />
                    <img src="img/funko-6.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="90,00">R$ 89,99</td>
          ...
          <span data-placeholder="Cidade*"></span>
			...
			<b>Forma de pagamento</b>
				...
				<tr>
					...
					<td>Total: R$<input name="total" type="number" "resultado3" readonly id="resultado3" min="1" max="1000" ></td>
