...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca Game Of Thrones Escudo Lannister 3D">Caneca Game Of Thrones Escudo Lannister 3D<br />
                    <img src="img/caneca-4.jpg" width="200px"; height="200px"
                    </td>
