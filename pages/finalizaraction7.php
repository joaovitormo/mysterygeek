...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Action Figure Crash Regular Edition - Crash Bandicoot">Action Figure Crash Regular Edition - Crash Bandicoot<br />
                    <img src="img/actionfigures-7.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="429,98">R$ 429,99</td>
