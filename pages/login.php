...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link rel="icon" href="img/icon.png" />
		...
		<title>Minha Conta - Mystery Geek</title>
</head>
...
<div class="barra_pesquisa">
	...
	<div class="contents">
        ...
        <input type="submit" class="cadbtn" value="ENTRAR">

        <div class="bottom-text">
          Ainda não tem uma conta? Faça já seu cadastro <a href="cadastro.php">clicando aqui</a>.
        </div>
				</form>
			<div class="cartaobanner"></div>
            </div>
