...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caderno Univ 12x1 240f Harry Potter Jandaia">Caderno Univ 12x1 240f Harry Potter Jandaia<br />
                    <img src="img/caderno-4.jpg" width="200px"; height="200px"
                    </td>
