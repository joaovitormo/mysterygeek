...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caneca com Brasão – Avengers Logo">Caneca com Brasão – Avengers Logo<br />
                    <img src="img/caneca-5.jpg" width="200px"; height="200px"
                    </td>
