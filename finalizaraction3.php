...
<body>
	...
	<header>
		...
		<div class="conta"><a href="#"><i class="fas fa-shopping-bag fa-3x" style="padding-left: 5px"></i><br>CESTA</a></div>
...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Boneco Kylo Ren (Unmasked): Star Wars (The Black Series)">Boneco Kylo Ren (Unmasked): Star Wars (The Black Series)<br />
                    <img src="img/actionfigures-3.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="89,98">R$ 89,99</td>
					...
					<td><b style="font-size: 14px">Selecione a quantidade desejada</b><br><input type="number" min="1" max="5" value="1" name="quantidade" id="quantidade"  onblur="soma()"></td>
							<td>R$ <input type="number" name="resultado" "resultado" readonly id="resultado" min="1" max="4"></td>
					</tr>
				</table><br />
				...
				<div class="alert alert-danger" role="alert">
					...
					<h3>Quantidade de parcelas:<input type="number" min="0" max="1" value="1" name="parcelas" id="parcelas"  onblur="dividir()"><br> </h3>
          ...
          <span data-placeholder="Cidade*"></span>
			...
			<b>Forma de pagamento</b>
				...
				<tr>
					...
					<td>Total:<input name="total" type="number" "resultado2" readonly id="resultado2" min="1" max="4" ></td>
