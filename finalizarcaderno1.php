...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Caderno Universitário Capa Dura 20x1 400 Liga da Justiça">Caderno Universitário Capa Dura 20x1 400 Liga da Justiça<br />
                    <img src="img/caderno-1.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="33,98">R$ 33,99</td>
