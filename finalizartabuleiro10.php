...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Claim + (Promo Fantasmas)">Claim + (Promo Fantasmas)<br />
                    <img src="img/tabuleiro-10.jpg" width="200px"; height="200px"
                    </td>
					<td> <input name="preco" type="hidden" id="preco" value="37,98">R$ 37,99</td>
