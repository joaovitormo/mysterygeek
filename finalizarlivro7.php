...
<div class="barra_pesquisa">
	...
	<form action="salva_compra.php" method="post">
				...
				<tr>
					...
					<td><input type="hidden" name="produto" value="Livro Batman – Os Arquivos Secretos do Homem-Morcego">Livro Batman – Os Arquivos Secretos do Homem-Morcego<br />
                    <img src="img/livro-7.jpg" width="200px"; height="200px"
                    </td>
